...
unsigned long myChannelNumber = 267XX; //填入thingspeak channel ID ***必填
const char * myWriteAPIKey = "Z9LVXARGKI6KXXXX"; //填入thingspeak API key ***必填

//Blynk設定

char auth[] = "07dfd97a0c8c4927ba6a67126fXXXXXXX"; //填入blynk auth key ***必填

//版本號
#define VERSION "v099b0311"
