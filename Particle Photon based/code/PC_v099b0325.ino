...
unsigned long myChannelNumber = 102823; //填入thingspeak channel ID ***必填
const char * myWriteAPIKey = "TGC9MVA76xxxxxx"; //填入thingspeak API key ***必填

//Blynk設定

char auth[] = "8a4e0d0d3d3444e6bdf64xxxxxxx"; //填入blynk auth key ***必填
